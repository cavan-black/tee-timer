...
@app.get("/credits")
def credits():
    """Who each course photograph belongs to, and how a club asks for one to be
    taken down. Generated by tools/credits.py from the image manifest."""
    return _page("credits")
